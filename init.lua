...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- NOTE: Telescope keybindings are now managed in lua/custom/plugins/editor/telescope.lua
      -- This avoids duplication and centralizes telescope configuration
    end,
  },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE: LSP keybindings are now managed in lua/custom/config/keymaps.lua
          -- This provides consistent keybinding patterns across all LSP servers
          require('custom.config.keymaps').setup_lsp_keymaps(event.buf)
